...
public class ShowQuestionAndAnswerActivity extends AppCompatActivity  implements ShowQuestionAndAnswerContract.View {
    private ShowQuestionAndAnswerContract.Presenter presenter;
    ...
    private void init() {
        presenter=new ShowQuestionAndAnswerPresenter(this,this);
    ...
    public void loadImageAndRadioButton(String examAnswer, String linkQs, String asExamDid) {
