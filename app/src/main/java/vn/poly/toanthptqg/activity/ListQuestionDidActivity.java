...
public class ListQuestionDidActivity extends BaseActivity {
    ...
    private void handlingTheme(TextView tvQuestion,String AnswerExemDid,String AnswerExam,ImageView imgResult ){
