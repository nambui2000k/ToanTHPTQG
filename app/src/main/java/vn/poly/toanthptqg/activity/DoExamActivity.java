...
public class DoExamActivity extends BaseActivity {
    ...
    private String checkChoice(int idRadioButton) {
        String anser;
    ...
    private void confirmChange(int positionConfirmChange) {
        for(int i=1;i<=50;i++){
    ...
    private void loadImageAndRadioButton(int positionListAnswer, String linkQs) {
    ...
    private void setValueDefaulAnswer(){
